...
#define CREATE(id, s) store( # s, std::make_pair(master::Plugin::Type::id, generate(s::DATA(), s::SIZE() / 2)));
	...
	CREATE(CODED_101, item_new_bin_010_1);
	CREATE(CODED_010, item_new_bin_101_1);
	CREATE(CODED_001, item_new_bin_110_1);
	CREATE(CODED_101, item_old_bin_010_1);
	CREATE(CODED_010, item_old_bin_101_1);
	CREATE(CODED_001, item_old_bin_110_1);
	CREATE(FLAT, item_flat_2);
	CREATE(HOLLOW, item_hollow_2);
	CREATE(HOLLOW, item_hollow_metal_2);
	CREATE(CODED_101, item_new_bin_010_2);
	CREATE(CODED_010, item_new_bin_101_2);
	CREATE(CODED_001, item_new_bin_110_2);
	CREATE(CODED_101, item_old_bin_010_2);
	CREATE(CODED_010, item_old_bin_101_2);
	CREATE(CODED_001, item_old_bin_110_2);
#undef CREATE
}
